...
<div id="intro-steps" class="video-steps active">
<h3>Steps</h3>
<div class="step-accordion">
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">1.</span><span class="step-text">Using Google Chrome, log in to B1.church.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/1.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">2.</span><span class="step-text">Click sign in and enter your username and password.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/2.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">3.</span><span class="step-text">This will take you to the B1.church Admin dashboard. From here, you can manage your church's database, website, mobile app, lessons, and more.</span><span class="step-arrow">▼</span></div>
  ...
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">10.</span><span class="step-text">Choose Lessons.church.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/10.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">11.</span><span class="step-text">This will take you to Lessons.church, where you can manage your church's online lessons and curriculum.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/11.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">12.</span><span class="step-text">Switch back to B1.church by clicking the arrow next to your profile picture and choosing Switch App again.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/12.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">13.</span><span class="step-text">You can now enter B1.church through the member portal or the admin portal. The member portal allows you to see how B1.church looks to your members, view your groups, and manage your personal donations.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/13.png" onclick="showModal(this.src)"></div>
  <div class="step-header" onclick="toggleStep(this)"><span class="step-num">14.</span><span class="step-text">This video is just a brief introduction to B1.church. Be sure to watch our tutorials to help you get the most out of these programs.</span><span class="step-arrow">▼</span></div>
  <div class="step-content"><img src="../videos/b1Admin/intro/14.png" onclick="showModal(this.src)"></div>
</div>
</div>
