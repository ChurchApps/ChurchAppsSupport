...
When you open the **Household** tab, you will see a list of the people in your household. Each member's entry shows:

- **Name** -- The person's first and last name
- **Role** -- Their role within the household (such as Head or Other)
- **Profile photo** -- Their picture, if one has been uploaded

Your household is a shared group that ties your family members together within the church's system.
