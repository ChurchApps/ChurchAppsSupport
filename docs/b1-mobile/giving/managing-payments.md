...
When you open the **Manage** tab, you will see a list of all your saved payment methods. Each entry shows the card type and the last four digits of the card number, so you can easily identify which card is which.
...
If you no longer want a card on file, you can remove it from the **Manage** tab:

1. Find the card you want to remove in your list of saved payment methods.
2. Tap the remove or delete option next to the card.
