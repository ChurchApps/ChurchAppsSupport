...
When no live stream is currently active, the screen may show offline content or information about the next scheduled service.
...
Your church sets specific times for when the stream becomes available. You may see a countdown or offline message before the service starts. After the broadcast ends, the stream screen returns to its offline state.

:::info
If the stream screen shows a countdown or offline message, the next scheduled service has not started yet. Check back at the listed service time.
:::
