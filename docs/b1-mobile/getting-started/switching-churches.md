...
1. Open the drawer menu by tapping the **hamburger icon** (three horizontal lines) in the top-left corner.
2. In the drawer header, tap the button showing your current church name (or **Find a Church** if no church is selected).
...
The Church Search screen remembers churches you have visited before. When you have not typed a search query, your recent churches are displayed automatically. This makes it quick to switch back to a church you use regularly.

:::tip
You do not need to log out and log back in to switch churches. Your single ChurchApps account works across all your churches. Just select a different church from the Church Search screen and you are ready to go.
:::
