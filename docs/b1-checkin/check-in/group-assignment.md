...
Groups are displayed in **categories**. Each category appears as a card showing:
...
:::info
Groups and categories are configured by your church administrator in B1 Admin. If a group is missing or in the wrong category, ask your admin to update the [group settings](../../b1-admin/groups/creating-groups.md).
:::
