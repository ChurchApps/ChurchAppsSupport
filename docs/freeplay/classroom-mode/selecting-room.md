...
1. From the **Select Pairing Mode** screen, choose **Pair to Classroom**
2. You will see the **Find Your Church** screen with a search field at the top
3. Using your TV remote, select the search field and type at least four letters of your church name
...
After selecting your church, the **Select a Classroom** screen appears with a list of all configured rooms.

1. Use the up and down arrows on your remote to browse the list of classrooms
2. Highlight the room this TV is assigned to
3. Press **Select** on your remote

FreePlay saves your choice and immediately moves to the download screen to fetch the scheduled lesson.

:::tip
If you see "No classrooms found," your church's classrooms have not been configured yet. An administrator can set them up at [freeplay.church](https://freeplay.church).
:::
