...
In B1 Admin, open the **section menu** in the top-left corner (the section name with the small arrow), choose **Settings**, and select the **Campuses** card. You can also go straight there at **/settings/campuses**. You will see a list of all configured campuses with their name, location, and timezone.
