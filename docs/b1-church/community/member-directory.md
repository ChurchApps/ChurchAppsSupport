...
The page uses a master-detail layout. On the left side, you have two ways to find people:

### Search by Name

1. Make sure the **People** filter is selected at the top of the search area.
2. Type a name into the search box.
3. Click **Search** or press **Enter** to see results.

If you leave the search box empty and click **Search**, the full directory listing is shown.

### Search by Group

1. Click the **Groups** filter at the top of the search area.
...
Click on any member in the list to open their profile in the detail panel on the right. The profile shows the member's information as configured by your church, which may include contact details, household members, and group memberships.
