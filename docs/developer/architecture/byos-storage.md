...
Scope note: BYOS covers the `/content/files` surfaces only. Gallery images, thumbnails, logos and person photos stay on the default provider (small, CDN-served, image-optimized).
