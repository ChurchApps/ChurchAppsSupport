...
- L'evento deve avere la registrazione abilitata e la finestra di registrazione deve essere aperta
...
Se hai bisogno di annullare, contatta l'amministratore della tua chiesa. Può annullare la tua registrazione dalla pagina delle registrazioni di B1 Admin.
