...
- Hai bisogno di un account B1 Admin attivo con il permesso di gestire le persone. Consulta [Ruoli e permessi](roles-permissions.md) se non sei sicuro del tuo livello di accesso.
- Se stai aggiungendo più di poche persone, considera di utilizzare lo strumento [Importazione CSV](importing-data.md).
...
:::tip
Se stai migrando da un altro sistema di gestione della chiesa, la funzione [Importa dati](importing-data.md) ti permette di importare l'intero elenco da un file CSV — molto più veloce che aggiungere le persone una alla volta.
:::
...
- **Presenze** — Visualizza i [registri di presenza](../attendance/tracking-attendance.md)
- **Donazioni** — Visualizza la [cronologia donazioni](../donations/recording-donations.md)

## Lavorare con i moduli

Puoi compilare moduli personalizzati direttamente dal profilo di una persona. Questi sono moduli definiti dall'utente che puoi creare seguendo la guida [Creazione moduli](../forms/creating-forms.md).
...
:::info
I moduli collegati al profilo di una persona utilizzano il tipo di modulo **Persone**. Se hai bisogno di un modulo autonomo (come la registrazione a un evento), consulta l'[opzione Modulo autonomo](../forms/creating-forms.md) nella guida ai moduli.
:::

## Gestione dei nuclei familiari

I nuclei familiari ti permettono di collegare i membri della famiglia. Questo è particolarmente utile per il [check-in](../attendance/check-in.md), dove un genitore può registrare tutti i propri figli contemporaneamente.
