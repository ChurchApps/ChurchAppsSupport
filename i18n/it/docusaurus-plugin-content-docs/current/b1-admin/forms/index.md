...
La sezione Moduli ti permette di creare moduli personalizzati per registrazioni, sondaggi, raccolta dati e altro ancora. Che tu abbia bisogno di una scheda visitatore, di un modulo di iscrizione a un evento o di un modulo per richieste di preghiera, puoi crearlo qui e condividerlo con la tua congregazione tramite un link pubblico o il tuo sito web B1.church.
...
- [Creazione di moduli](./creating-forms.md) -- Guida passo passo per creare moduli e aggiungere domande.
- [Gestione degli invii](./managing-submissions.md) -- Come visualizzare e gestire le risposte ai moduli.
