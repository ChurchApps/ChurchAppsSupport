...
| POST | / | JWT | — | Formularantworten einreichen (verarbeitet begrenzte/unbegrenzte Formulare, sendet E-Mail-Benachrichtigungen). Wenn das Formular utoCreatePerson hat, findet oder erstellt einen Gasteintrag nach E-Mail und verknüpft die Einreichung; wenn ollowUpSubject/ollowUpBody gesetzt sind, sendet eine vorlagengesteuerte Nachfolge-E-Mail an die einreichende Person |
