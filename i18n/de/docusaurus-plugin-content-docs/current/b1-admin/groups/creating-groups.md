...
- Sie benötigen ein aktives B1 Admin-Konto mit Berechtigung zum Verwalten von Gruppen. Siehe [Rollen & Berechtigungen](../people/roles-permissions.md), wenn Sie sich über Ihre Zugriffsebene unsicher sind.
...
3. Konfigurieren Sie die folgenden Optionen:
   ...
   - **Beitrittsrichtlinie** -- Wählen Sie, wer dieser Gruppe beitreten kann:
     ...
     - **Anfrage** -- Personen müssen eine Beitrittsanfrage stellen, die eine Genehmigung erfordert (siehe [Gruppenbeitrittsanfragen](./group-join-requests.md))
   ...
   - **Gottesdienstzeiten** -- Ordnen Sie die Gruppe bestimmten Gottesdienstzeiten der Gemeinde zu, falls zutreffend. Siehe [Anwesenheits-Einrichtung](../attendance/setup.md) für Details zu Gottesdienstzeiten.
...
- **Mitglieder hinzufügen** -- Suchen Sie nach Personen und fügen Sie sie der Gruppe hinzu. Verwenden Sie das grüne Schlüssel-Symbol, um Gruppenleiter zu bestimmen. Siehe [Gruppenmitglieder](./group-members.md).
