...
- [Busca un miembro](./looking-up-members) y selecciónalo de los resultados de búsqueda
...
- Su **foto** (o un icono de marcador de posición si no hay foto en archivo)
...
- El **nombre de la hora de servicio** (por ejemplo, "9:00 AM" u "11:00 AM")
- Un **botón** que muestra el grupo actualmente asignado, o "Select Group" si aún no se ha asignado ningún grupo
...
La tarjeta expandida también muestra fichas **Member**, **Guest**, y **Volunteer**. Toca una para establecer cómo esta persona está registrándose -- Member es el valor predeterminado. El tipo importa para salas infantiles: los voluntarios cuentan hacia la proporción de voluntario a niño de la sala, y los invitados cuentan contra cualquier capacidad de invitado que tu iglesia haya establecido.
...
- **Toca el botón Add Guest** debajo de la lista de miembros para [agregar un invitado](./adding-guests) a tu hogar.
- **Toca el botón Check-in** en la parte inferior de la pantalla para [completar el check-in](./completing-checkin) para todos en el hogar.

:::info
Cualquier asignación de grupo de un check-in anterior al mismo servicio se precarga automáticamente. Si tus hijos asisten a los mismos grupos cada semana, es posible que no necesites cambiar nada -- solo revisa y regístrate.
:::
...
- [Completa el check-in](./completing-checkin) cuando las asignaciones de todos se vean correctas.
