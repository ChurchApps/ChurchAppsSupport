...
Las campañas te permiten realizar una recaudación de fondos hacia un objetivo específico — un fondo de construcción, un viaje misionero, un proyecto especial — y rastrear promesas de miembros junto con donaciones reales para que puedas ver tu progreso en tiempo real.
...
- Configura tus [fondos de donación](funds) — cada campaña está vinculada a un fondo
- Necesitas acceso a la sección Donaciones de B1 Admin
...
1. Abre una campaña.
2. Haz clic en **Agregar Promesa**.
3. Selecciona la **persona** haciendo la promesa.
4. Ingresa la **cantidad** de la promesa.
5. Opcionalmente establece una **fecha** para el compromiso de la promesa.
6. Haz clic en **Guardar**.

Las promesas aparecen en el detalle de la campaña y contribuyen al total **Prometido** en la tarjeta de campaña.
...
- [Registrar Donaciones](recording-donations) — registra los regalos reales que cumplen con las promesas
- [Fondos](funds) — configura el fondo para asociar con una campaña
- [Reportes de Donaciones](donation-reports) — informes sobre donaciones por fondo
