...
Una vez que tu grupo está creado, puedes rellenar detalles adicionales:

1. Haz clic en el **nombre del grupo** en la lista para abrirlo.
2. Haz clic en el **icono de lápiz** para editar los ajustes del grupo.
3. Configura las siguientes opciones:
   - **Descripción** -- Un resumen breve de qué se trata el grupo. Esto es visible para los miembros.
...
:::tip
Agregar una descripción clara y un horario de reunión ayuda a los miembros a saber qué esperar cuando se unan a un grupo.
:::
...
Cuando un grupo ya no está activo pero deseas mantener su historial en lugar de eliminarlo:

1. Abre el grupo y haz clic en el **icono de lápiz** para editar sus ajustes.
2. Haz clic en **Archivar** y confirma.

Los grupos archivados desaparecen de la lista principal de grupos. Para encontrar uno nuevamente, activa el botón **Mostrar archivados** en la parte superior de la página de grupos, luego haz clic en **Restaurar** junto al grupo para devolverlo.

:::info
Archivar un grupo no elimina sus miembros, historial de asistencia, o eventos de calendario -- solo oculta el grupo de la lista predeterminada hasta que lo restaures.
:::
