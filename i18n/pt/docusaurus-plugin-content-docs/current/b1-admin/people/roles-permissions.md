...
- As pessoas às quais você deseja atribuir funções já devem existir no seu diretório. Consulte [Adicionar pessoas](adding-people.md) se precisar adicioná-las primeiro.

</div>

## Entendendo funções

Uma função é um conjunto de permissões que você atribui a um ou mais usuários. Por exemplo, você pode criar uma função "Equipe Financeira" que concede acesso aos [registros de doações](../donations/recording-donations.md), ou uma função "Voluntário de Check-In" que permite acesso apenas aos [recursos de presença](../attendance/check-in.md).
...
- **Grupos** -- gerenciar [participação em grupos](../groups/group-members.md) e calendários
...
- **Líderes de grupo** -- acesso apenas a [Grupos](../groups/creating-groups.md)
- **Voluntários de Check-In** -- acesso apenas a [Presença](../attendance/check-in.md)
- **Equipe financeira** -- acesso a [Doações](../donations/recording-donations.md) e relatórios
