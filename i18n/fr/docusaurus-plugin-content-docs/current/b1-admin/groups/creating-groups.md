...
- Vous avez besoin d'un compte B1 Admin actif avec la permission de gérer les groupes. Consultez [Rôles et permissions](../people/roles-permissions.md) si vous n'êtes pas sûr de votre niveau d'accès.
...
3. Configurez les options suivantes :
   ...
   - **Politique d'adhésion** -- Choisissez qui peut rejoindre ce groupe :
     ...
     - **Demande** -- Les personnes doivent soumettre une demande d'adhésion qui nécessite une approbation (voir [Demandes d'adhésion aux groupes](./group-join-requests.md))
     - **Fermé** -- Les membres doivent être ajoutés manuellement par les responsables ou les administrateurs
   - **Suivi de la présence** -- Activez ceci si vous souhaitez enregistrer la [présence](../attendance/tracking-attendance.md) pour ce groupe.
   - **Heures de service** -- Associez le groupe à des heures de service d'église spécifiques si applicable. Consultez [Configuration de la présence](../attendance/setup.md) pour plus de détails sur les heures de service.
...
- **Ajouter des membres** -- Recherchez des personnes et ajoutez-les au groupe. Utilisez l'icône de clé verte pour désigner les responsables de groupe. Consultez [Membres du groupe](./group-members.md).
