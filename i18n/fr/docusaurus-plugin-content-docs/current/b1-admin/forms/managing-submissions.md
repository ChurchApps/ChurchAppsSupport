...
- [Créez un formulaire](./creating-forms.md) avec au moins une question
- Partagez le formulaire via son URL publique ou intégrez-le sur votre [site web](../website/managing-pages.md)
...
- Apprenez à créer et personnaliser des formulaires dans [Créer des formulaires](./creating-forms.md)
- Ajoutez les personnes issues des soumissions de formulaires à votre [répertoire de personnes](../people/adding-people.md) pour un suivi continu
