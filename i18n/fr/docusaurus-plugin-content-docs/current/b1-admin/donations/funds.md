...
Accédez à **Dons > Fonds** pour voir la liste de tous vos fonds. Chaque ligne affiche le nom du fonds et son statut de **déductibilité fiscale**, qui détermine si les dons à ce fonds apparaissent sur les [reçus fiscaux](giving-statements.md) de fin d'année.
...
:::tip
Configurez vos fonds avant de commencer à [enregistrer des dons](recording-donations.md). Avoir tous les fonds en place garantit que les dons sont correctement catégorisés dès le départ.
:::

## Prochaines étapes

Une fois vos fonds configurés, vous pouvez les affecter aux dons lors de l'[enregistrement des dons](recording-donations.md) dans un lot. Assurez-vous de marquer les fonds appropriés comme déductibles d'impôts avant de générer les [reçus fiscaux](giving-statements.md).
