...
- Assurez-vous que les personnes ou les [groupes](../groups/creating-groups.md) auxquels vous souhaitez attribuer des tâches existent dans B1 Admin
...
:::info
Vous pouvez automatiser les tâches récurrentes pour qu'elles soient créées selon un calendrier. Consultez [Automatisations](./automations.md) pour plus de détails sur la configuration.
:::

## Prochaines étapes

- Configurez des [Automatisations](./automations.md) pour créer automatiquement des tâches récurrentes
- Utilisez les tâches en complément des [Planifications de culte](./plans.md) pour suivre les actions de préparation du culte
