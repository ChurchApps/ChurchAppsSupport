...
:::tip
Voor de beste resultaten gebruikt u een logo met een transparante achtergrond in PNG-indeling. Dit zorgt ervoor dat het op zowel lichte als donkere achtergronden er geweldig uitziet in uw website en [mobiele app](../settings/mobile-app.md).
:::
...
- [Pagina's beheren](managing-pages) -- Bouw en organiseer uw website pagina's
- [Bestanden](files) -- Upload media-assets voor uw site
