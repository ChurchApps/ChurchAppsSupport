...
2. Fill out your church's info:
   <img width="1511" alt="002" src="https://user-images.githubusercontent.com/65249159/192036031-0b380008-dd72-43c3-8bfe-0f37bafd9798.png">
3. After clicking Register, go to the email you used and click on Set Password:
   <img width="913" alt="003" src="https://user-images.githubusercontent.com/65249159/192036157-1c3e7099-da3d-4ae4-bd67-b6f4aa492d44.png">
4. Set a password:
   <img width="1494" alt="004" src="https://user-images.githubusercontent.com/65249159/192036288-d5322e5a-b38b-41c3-847a-b53bae4d1fde.png">
5. Click Sign In. You will then be prompted to search for your church:
   <img width="1494" alt="006" src="https://user-images.githubusercontent.com/65249159/192036882-083be3dd-6544-4d38-95ba-6492768b5409.png">
6. If the program can not find your church, click on Register a New Church:
   <img width="1494" alt="007" src="https://user-images.githubusercontent.com/65249159/192037067-2851a43d-0319-426b-8133-77c80e780989.png">
7. Confirm you do want to register a new church by selecting ok:
...
9. If they are not in the system, enter their first and last name and click ADD:
...
10. Click on the edit pencil to edit that person's information
    <img width="1494" alt="014" src="https://user-images.githubusercontent.com/65249159/192038802-31a79cea-e617-4612-b297-133ce187af69.png">
11. Enter as much detail as you have, then click SAVE:
    <img width="1494" alt="016" src="https://user-images.githubusercontent.com/65249159/192039176-1e50d90d-16e4-46fa-8910-e68069843252.png">
    14.Click on the People icon and add as many people as you need:
...
12. Connect Families togther; Click on an Adult in the Family:
...
13. Click on the pencil to edit the household:
...
14. Add all Family members togther:
...
15. Next Click on the attendace icon:
...
16. Click on the + icon to add a campus:
...
17. Click on Add Campus and name your campus
...
18. Click on Add Service and name the service:
...
19. Click on Add Service Time and add the time of your service:
...
20. Next click on the groups icon:
...
21. Click on the + sign to add a new group:
...
22. Continue to add as many groups as your church needs:
...
23. Click on the name of the group you would like to setup for checkin then click the edit button:
...
24. At this point you need to set each group according to what you want to happen at checkin. If you want to track attendance make sure to select Yes. Parent pickup means that when checkin happens on the app it will print a kid tag and parent tag for that group.
...
[CLick here for a great video on setting up the printer](https://www.youtube.com/watch?v=U5pmTRddt2w)
