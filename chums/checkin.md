...
1. Setup an account on [Chums Account](https://chums.org/) If you allready have one please skip to step 9.
...
5. Click Sign In You will then be promted to search for your church:
...
7. Confirm you do want to create a new Church by selting ok:
...
10: First we need to add all the people who will be checking in. There are sevral ways to do this if you allready have all the data but for demonstration we are going to show how to add each person. Search for who you would like to add.
...
11. If they are not in the System Put their first and last name in and click Add:
...
12. Click on the edit pencil to edit that persons information
...
13. Put as much detail as you have for now in then click save:
